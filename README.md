...
* **Multimedia-Unterstützung:** Nutze einfache Befehle für Medieninhalte:
    * `/image(url)` – Zeige Bilder oder GIFs an.
    * `/video(url)` – Bette YouTube-Videos oder MP4-Dateien ein.
    * `/audio(url)` – Spiele Soundeffekte oder Musikausschnitte ab.
